...
The app generates an html file with the three closest birthdays. If a birthday within the reminder distance, the default browser will pop up and show to show the created file.
...
* Run the app.py file
* Use a scheduler to execute once a day
